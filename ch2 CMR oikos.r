...
mat.indices<-grep('Mat:(',compare$model.table$Psi,fixed=TRUE)
stratum.indices<-grep('stratum',compare$model.table$Psi)
pdo.indices<-grep('pdo',compare$model.table$Psi)
pdolag.indices<-grep('pdolag',compare$model.table$Psi)
NJ.indices<-grep('NJ',compare$model.table$Psi)
BRD.indices<-grep('BRD',compare$model.table$Psi)
...
stratum.Psi<-sum(compare$model.table$weight[grep('stratum',compare$model.table$Psi)])
pdo.Psi<-sum(compare$model.table$weight[grep('pdo',compare$model.table$Psi)])
pdolag.Psi<-sum(compare$model.table$weight[grep('pdolag',compare$model.table$Psi)])
NJ.Psi<-sum(compare$model.table$weight[grep('NJ',compare$model.table$Psi)])
BRD.Psi<-sum(compare$model.table$weight[grep('BRD',compare$model.table$Psi)])
Imm.Psi<-sum(compare$model.table$weight[grep('Mat',compare$model.table$Psi,fixed=TRUE)])
mat.stratum.Psi<-sum(compare$model.table$weight[mat.stratum])
mat.pdo.Psi<-sum(compare$model.table$weight[mat.pdo])
mat.pdolag.Psi<-sum(compare$model.table$weight[mat.pdolag])
mat.NJ.Psi<-sum(compare$model.table$weight[mat.NJ])
mat.BRD.Psi<-sum(compare$model.table$weight[mat.BRD])

stratum.S<-sum(compare$model.table$weight[grep('stratum',compare$model.table$S)])
pdo.S<-sum(compare$model.table$weight[grep('pdo',compare$model.table$S)])
pdolag.S<-sum(compare$model.table$weight[grep('pdolag',compare$model.table$S)])
NJ.S<-sum(compare$model.table$weight[grep('NJ',compare$model.table$S)])
BRD.S<-sum(compare$model.table$weight[grep('BRD',compare$model.table$S)])
stratum.int.S<-sum(compare$model.table$weight[grep(' *',compare$model.table$S,fixed=TRUE)])
