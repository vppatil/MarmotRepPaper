...
#setwd('~/Dropbox/thesis stuff/marmot data files')
...
lmer2<-lmer(juvs~offset(log(ad.fems))+PDO+(PDO-1|Social.Group)+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer3<-lmer(juvs~offset(log(ad.fems))+PDOlag+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer4<-lmer(juvs~offset(log(ad.fems))+N.group+PDO+(PDO-1|Social.Group)+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer5<-lmer(juvs~offset(log(ad.fems))+N.group+PDOlag+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer6<-lmer(juvs~offset(log(ad.fems))+PDO+PDOlag+(PDO-1|Social.Group)+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer7<-lmer(juvs~offset(log(ad.fems))+N.group+PDO+PDOlag+(PDO-1|Social.Group)+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer8<-lmer(juvs~offset(log(ad.fems))+N.group*PDO+(PDO-1|Social.Group)+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer9<-lmer(juvs~offset(log(ad.fems))+N.group*PDOlag+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer10<-lmer(juvs~offset(log(ad.fems))+N.group*(PDO+PDOlag)+(PDO-1|Social.Group)+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
lmer11<-lmer(juvs~offset(log(ad.fems))+1+(PDO-1|Social.Group)+(1|Social.Group),family=poisson,data=dat,na.action=na.omit)
